...
lines = [
    "# DIHEDRAL ghost-ring springs: real AMBER ff99SB torsion parameters",
    "# (OpenMM amber99sb.xml), for the 18 residue types, both free termini of",
    "# each, and the ACE/NME caps -- all of them enumerated from",
    "# amber99sb.xml's own residue templates, no structure.",
    "# Generated by scripts/generate_bonded_forcefield.py -- do not",
    "# hand-edit individual values, regenerate instead.",
    "#",
    "# Bonds and valence angles are NOT here. They used to be emitted as",
    "# STRETCH and BEND families; both were removed, because the ghost rings",
    "# deform a flexible mesh instead of applying a pure torque, so letting",
    "# bonds and angles move as well destroyed the geometry. They now live in",
    "# the rigid-body mesh (--rigidbody, ProteinAtomRigidGroups.rbody), which",
    "# is why this file still reads AMBER bond lengths and angles: the rings'",
