...
lines = [
    ...
    "# types, both free termini of each, and the ACE/NME caps -- all of them",
    "# enumerated from amber99sb.xml's own residue templates, no structure.",
...
print(f"\nWrote {n_ok} unique STRETCH/BEND entries ({n_skip} skipped), {axes.n_ghost_particles} "
     f"GHOSTPARTICLE entries and {axes.n_dihedral_ok} DIHEDRAL entries ({axes.n_dihedral_skip} skipped) to {OUT}")
